...
│   └── threshold_analysis.py          # Cost-benefit analysis across all thresholds
│
├── api/
│   └── serve.py                        # FastAPI — /predict, /explain, /investigate, /health
│
├── tests/
│   └── test_pipeline.py                # 11 automated tests (run in CI)
│
...
│   ├── API_running_locally_RF.png
│   ├── Docker container running.png
│   ├── ECR.png
│   ├── SageMaker endpoint InService.png
│   ├── DataCapture.png
│   ├── S3_data_capture.png
│   ├── Data_capture_baseline.png
│   ├── ModelMonitorSetUp.png
│   ├── Cloudwatch_logs_Sagemaker.png
│   ├── Cloudwatch_Sagemaker.png
│   ├── Metrics.png
│   └── Metrics2.png
│
├── .github/
...
│
├── Dockerfile                          # Local development container — port 8000
├── Dockerfile.sagemaker                # SageMaker container — port 8080 + serve script
├── serve                               # SageMaker entry point script
├── deploy_sagemaker.py                 # Deploy endpoint with data capture to SageMaker
├── setup_model_monitor.py             # Create baseline and schedule hourly monitor
├── test_sagemaker.py                   # Test live endpoint and verify S3 capture
├── send_predictions.py                 # Send bulk predictions for testing
├── test_drift.py                       # Send out-of-distribution claims to trigger violations
├── check_monitor.py                    # Check monitoring execution status and violations
